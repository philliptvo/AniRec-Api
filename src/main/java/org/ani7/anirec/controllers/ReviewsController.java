...
public class ReviewsController {
    ...
    @GetMapping("")
    public List<Reviews> getAllReviews(@Param("keyword") String keyword, @RequestParam(defaultValue = "1") String pageNum,
                                       @RequestParam(defaultValue = "25") String pageSize) {
        Page<Reviews> page = service.findAllReviews(keyword, Integer.parseInt(pageNum) - 1,
